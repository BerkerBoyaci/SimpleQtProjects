...
void MainWindow::on_actionFind_triggered()
{
    ...
    if(!value)
        QMessageBox::information(this, "Not found","Was not able to find: " + dlg->text());
}
...
void MainWindow::checkSave()
{
    ...
    QMessageBox::StandardButton value = QMessageBox::question(this, " Save File?" , "You have  unsaved changes. Would you like to save?");
